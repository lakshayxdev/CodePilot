...
<div className="relative min-h-screen flex justify-center items-start md:items-center pt-28 md:pt-0 pb-8 px-6">
          ...
          <div className="w-full max-w-md mt-6 md:mt-0 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-3xl shadow-[0_20px_70px_rgba(0,0,0,.6)] p-6 sm:p-8 md:p-10">
